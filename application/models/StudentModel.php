...
class StudentModel extends CI_Model
{
    ...
    public function insert_student($data)
    {
        ...
        $father_id = $this->db->insert('tb_parent', $father);
        #พ่อผูกข้อมูลเด็ก
        ...
        $mother_id = $this->db->insert('tb_parent', $mother);
        #แม่ผูกข้อมูลเด็ก
    ...
    public function update_student($data, $std_id)
    {
        $this->db->trans_begin();
